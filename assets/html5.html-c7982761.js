import{_ as n,p as s,q as a,a1 as e}from"./framework-5866ffd3.js";const i={},o=e(`<h2>html5</h2><h3 id="本地存储" tabindex="-1"><a class="header-anchor" href="#本地存储" aria-hidden="true">#</a> 本地存储</h3><h4 id="localstorage" tabindex="-1"><a class="header-anchor" href="#localstorage" aria-hidden="true">#</a> localStorage</h4><p><code>localStorage</code> 是本地存储，存储的内容在关闭浏览器后再次点开网页时依然存在，需要手动清除才会消失（手动清除的方法有两种：1.调用API清除；2.直接在开发者工具中清除浏览器缓存）。</p><p>localStorage特点：</p><ol><li>永久性存储，可手动删除。</li><li>以字符串的形式存储数据。</li><li>一般浏览器的存储大小是5MB，即5120KB。</li></ol><div class="language-javascript line-numbers-mode" data-ext="js"><pre class="language-javascript"><code><span class="token comment">// 存数据</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h4 id="sessionstorage" tabindex="-1"><a class="header-anchor" href="#sessionstorage" aria-hidden="true">#</a> sessionStorage</h4><p><code>sessionStorage</code> 是会话存储，存储的内容会随着浏览器窗口的关闭而消失（关闭网页即会话结束）。</p><p>sessionStorage特点：</p><ol><li>暂时性存储，关闭窗口即清除数据。</li><li>以字符串的形式存储数据。</li><li>一般浏览器的存储大小是5MB，即5120KB。</li></ol><div class="language-javascript line-numbers-mode" data-ext="js"><pre class="language-javascript"><code><span class="token comment">// 存数据</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h5 id="区别" tabindex="-1"><a class="header-anchor" href="#区别" aria-hidden="true">#</a> 区别</h5><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>不同点：
1，与服务器之间的通信：
...
相同点：
都是保存在浏览器端、且同源的
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div>`,25),t=[o];function c(l,p){return s(),a("div",null,t)}const r=n(i,[["render",c],["__file","html5.html.vue"]]);export{r as default};
