import{_ as s,p as n,q as a,a1 as e}from"./framework-5866ffd3.js";const t={},o=e(`<h2 id="路径配置" tabindex="-1"><a class="header-anchor" href="#路径配置" aria-hidden="true">#</a> @路径配置</h2><p>vscode安装 <code>Path Intellisense</code> 插件</p><p>打开设置-首选项-搜索 <code>Path Intellisense</code> -打开 <code>settings.json</code> ，添加</p><div class="language-json line-numbers-mode" data-ext="json"><pre class="language-json"><code><span class="token property">&quot;path-intellisense.mappings&quot;</span><span class="token operator">:</span><span class="token punctuation">{</span>
...
<span class="token punctuation">}</span>
    ...
    <span class="token punctuation">]</span>
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div>`,6),p=[o];function c(l,i){return n(),a("div",null,p)}const r=s(t,[["render",c],["__file","at-path.html.vue"]]);export{r as default};
