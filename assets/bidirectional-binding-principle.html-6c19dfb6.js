import{_ as n,p as s,q as a,a1 as t}from"./framework-5866ffd3.js";const e={},p=t(`<h2 id="vue2双向绑定原理" tabindex="-1"><a class="header-anchor" href="#vue2双向绑定原理" aria-hidden="true">#</a> Vue2双向绑定原理</h2><p><code>Object.defineProperty()</code> 是ES5中一个无法shim的特性，可以用来给对象设置属性</p><p>一个shim是一个库，它将一个新的API引入到一个旧的环境中，而且仅靠旧环境中已有的手段实现。 比如：google和github上都有一段用于兼容ie等低版本浏览器的html标签库 html5shiv，ps: shim有时也叫shiv。</p><p>第一种方法：</p><div class="language-javascript line-numbers-mode" data-ext="js"><pre class="language-javascript"><code><span class="token keyword">let</span> obj <span class="token operator">=</span> <span class="token punctuation">{</span>
